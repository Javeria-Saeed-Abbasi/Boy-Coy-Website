...
(function () {
  for (
    ...
    d < b.length && !window.requestAnimationFrame;
    ++d
  )
    (window.requestAnimationFrame = window[b[d] + "RequestAnimationFrame"]),
      (window.cancelAnimationFrame =
        window[b[d] + "CancelAnimationFrame"] ||
        window[b[d] + "CancelRequestAnimationFrame"]);
  window.requestAnimationFrame ||
    (window.requestAnimationFrame = function (b, d) {
...
function EventManager(a) {
  ...
  this.dispatch = function (d) {
    a &&
      console.log(
        "Dispatching to event listeners. Targets serialization: " +
          JSON.stringify(b)
      );
...
function EventsManager(a) {
  ...
  this.registerType = function (d) {
    ...
    void 0 === b[d]
      ? (b[d] = new EventManager(a))
      : console.error('Type "' + JSON.stringify(d) + '" already registered.');
  };
  this.addEventListener = function (d, c) {
    a && console.log('Adding event listener for "' + d + '".');
    b[d]
      ? b[d].addEventListener(c)
      : console.error(
  ...
  this.dispatch = function (d) {
    a &&
      console.log(
        'Dispatching to event listeners for "' +
          d +
          '". Event managers serialization: ' +
          JSON.stringify(b)
      );
    if (b[d]) {
    ...
    for (var d in c) {
      ...
      f &&
        (b
          ? (f.style[a] =
              "translate" +
              (e.getType() === DrawerObject.HORIZONTAL ? "X" : "Y") +
              "(" +
              e.getOffset() +
              "px) translateZ(0px)")
          : (f.style[e.getType() === DrawerObject.HORIZONTAL ? "left" : "top"] =
              e.getOffset() + "px"));
    }
  });
  g();
...
var Parallaxer = function (a) {
  ...
  this.addElement = function (a, b, c, e) {
    var f = null;
    a &&
      ((f = { id: g.length, element: a, speed: b, type: e, scrollOffset: c }),
      g.push(f));
    d = !1;
    return f;
  };
  ...
  this.setTargetScrollPosition = function (a) {
    e !== a &&
      ((e = a),
      b.dispatch(
        ParallaxerEvent.TARGET_POSITION_CHANGED,
    ...
    n = Utils.delegate(this, function (a, q) {
      ...
      if (0.2 < l || q) {
        if (!1 === d)
          for (var n in g) {
            var k = g[n],
              t = k.element,
              u = 0,
              x = Utils.getComputedStyle(
                t,
                k.type == Parallaxer.HORIZONTAL ? "left" : "top"
              );
            "auto" !== x &&
              ((u += Number(x.replace(/px/, ""))),
              (t.style[k.type == Parallaxer.HORIZONTAL ? "left" : "top"] =
                "0"));
            k.initialVisiblePosition = u;
            m.addObject(
              k.id,
              t,
              k.type === Parallaxer.HORIZONTAL
        ...
        f
          ...
          : (c = e);
        b.dispatch(
          ParallaxerEvent.CURRENT_POSITION_CHANGED,
          new ParallaxerEvent(this)
        );
        m.startFrame();
        var l = c,
        ...
        for (y in g)
          (h = g[y]),
            m.updateOffset(
              h.id,
              Math.floor(
                h.initialVisiblePosition + (h.scrollOffset - l) * h.speed
              )
            );
        m.draw();
        !1 === d &&
          ((d = !0),
          b.dispatch(
            ParallaxerEvent.AFTER_FIRST_DRAW,
            new ParallaxerEvent(this)
          ));
      }
      return k;
...
var ParallaxeLoader = function (a, b) {
  var d = null,
    ...
    m = Utils.delegate(this, function () {
      ...
      new ParallaxerGroup(d, ".page4", -0.13, ParallaxerGroup.HORIZONTAL).add(
        ".page4 .layer.background1 .wave",
        1
      );
      new ParallaxerGroup(d, ".page4", 0.08, ParallaxerGroup.HORIZONTAL).add(
        ".page4 .layer.background2 .wave",
        1
      );
      new ParallaxerGroup(d, ".page4", -0.03, ParallaxerGroup.HORIZONTAL).add(
        ".page4 .layer.background3 .wave",
        1
      );
  ...
  var k = function () {
    ...
    h = Utils.delegate(this, function (b) {
      ...
      b + d / c.apps.getReferenceSpeed() < this.getGroupScrollPosition("apps")
        ? a.saveLocation("home")
        : b + d / c.about.getReferenceSpeed() <
          this.getGroupScrollPosition("about")
        ? a.saveLocation("apps")
        : b + d / c.contact.getReferenceSpeed() <
          this.getGroupScrollPosition("contact")
        ? a.saveLocation("about")
        : a.saveLocation("contact");
    }),
    n = function () {
      var a = f.speed,
        a =
          e.getContainerVisiblePosition() +
          $(window).height() +
          (f.initialVisiblePosition + 173 - $(window).height()) / a;
      $(".streacher").height(a);
    };
  m();
};
...
var UnderlineCreator = function (a) {
  ...
  var b = null,
    ...
    m = Utils.delegate(this, function () {
      ...
      a.find(".text").before(
        '<div class="linkLineContainer"><div class="linkLine"></div></div>'
      );
  ...
  var k = Utils.delegate(this, function () {
      if (!1 === e) {
        g = a.find(".text").width();
        e = !0;
        a.find(".text").stop().animate({ color: "#ffffff" }, 250);
        b.dispatch(this.SHOW, { containerElement: a, duration: 250 });
        var c = a.find(".linkLine");
        c.css("margin-left", 0);
        c.stop().animate({ width: g }, 250, function () {
          e = !1;
          !1 === d && l();
        });
      }
    ...
    l = Utils.delegate(this, function (e) {
      !1 === c &&
        ((c = !0),
        a.find(".text").stop().animate({ color: f }, 250),
        b.dispatch(this.HIDE, { containerElement: a, duration: 250 }),
        a
          .find(".linkLine")
          .stop()
          .animate({ "margin-left": g, width: 0 }, 250, function () {
            c = !1;
            !0 === d && k(e);
          }));
    });
...
var Baloons = function () {
  var a = $(".page2 .baloonLeft"),
    ...
    d = $(".page2 .baloonRight"),
    c = function () {
      a.stop().animate({ rotate: "-35deg" }, 1e4, function () {
        a.stop().animate({ rotate: "-25deg" }, 1e4);
      });
    },
    e = function () {
      b.stop().animate({ rotate: "5deg" }, 7500, function () {
        b.stop().animate({ rotate: "-5deg" }, 7500);
      });
    },
    f = function () {
      d.stop().animate({ rotate: "35deg" }, 9e3, function () {
        d.stop().animate({ rotate: "25deg" }, 9e3);
      });
    };
  (function () {
    c();
  ...
  (function () {
    ...
    a.on("click mousemove", function (a) {
      for (var c = 0; c < b.length; c++) {
        ...
        n && l
          ? (g.trigger(a.type),
            !1 == d[c] && ((d[c] = !0), g.trigger("mouseover")))
          : !0 == d[c] && ((d[c] = !1), g.trigger("mouseout"));
      }
    });
  })();
};
...
var Mail = function () {
  ...
  var q = function (a) {
      e.show();
      e.stop().animate({ top: 0 }, 1300, function () {
        b = !0;
        d && v();
        a && a();
      });
    ...
    s = function (a) {
      r();
      b = !1;
      e.stop().animate({ top: 255 }, 1300, function () {
        e.hide();
        a && a();
      });
    },
    ...
    r = Utils.delegate(this, function () {
      b && c.stop().animate({ top: g }, 1e3);
    }),
    w = function () {
      $(".page4 .envelopes").hover(
        function (a) {
          d = !0;
          v();
        },
    ...
    t = function (a, b) {
      "true" !== a.data("isErrorSet") &&
        (a.data("isErrorSet", "true"),
        console.log(b),
        a
          .find(".underline")
          .delay(b)
          .animate({ backgroundColor: "#ff0000" }, 400),
        a.find(".exclamationMark").delay(b).fadeIn(400));
    },
    u = function (a) {
      "true" === a.data("isErrorSet") &&
        (a.data("isErrorSet", "false"),
        a.find(".underline").animate({ backgroundColor: f }, 400),
  ...
  (function () {
    ...
    a.hover(
      function (b) {
        b.stopPropagation();
        a.stop().animate({ "background-color": "#363632" });
      },
      function (c) {
        c.stopPropagation();
        a.stop().animate({ "background-color": b });
      }
    );
    a.click(function () {
      var a = h.val(),
      ...
      if (0 < a.length && 0 < b.length && 0 < c.length) d = !0;
        ...
        var e = 0;
        !(0 < a.length) &&
          "true" !== m.data("isErrorSet") &&
          (t(m, 400 * e), e++);
        !(0 < b.length) &&
          "true" !== k.data("isErrorSet") &&
          (t(k, 400 * e), e++);
        !(0 < c.length) &&
          "true" !== l.data("isErrorSet") &&
          (t(l, 400 * e), e++);
      }
      !0 === d &&
        s(function () {
          var d = JSON.stringify({ name: a, from: b, content: c }),
            e = !1;
          $.get("sendmail.php", { data: d })
            .success(function () {
              e = !0;
    ...
    p = function () {
      ...
      if (0 !== d) {
        ...
        for (g = 0; g < Math.abs(d); g++)
          0 < d
            ? q()
            : (e.find(".underline").last().remove(),
              e.find("br").last().remove(),
              (m = e.find(".underline").last()),
              a.increaseOverPosition(l),
              b.stop().animate({ top: a.getOverPosition() + "px" }, 250),
              c.height(c.height() - l));
        f.css("height", k * l + 1);
      }
    },
...
var Menu = function () {
  ...
  var a = null,
    ...
    d = Utils.delegate(this, function () {
      ...
      var c = {
          home: Number(
            $(".menus .menu.home .over").css("width").replace(/px$/, "")
          ),
          apps: Number(
            $(".menus .menu.apps .over").css("width").replace(/px$/, "")
          ),
          about: Number(
            $(".menus .menu.about .over").css("width").replace(/px$/, "")
          ),
          contact: Number(
            $(".menus .menu.contact .over").css("width").replace(/px$/, "")
          ),
        },
      ...
      $(".menus .menu").each(function (a, b) {
        ...
        $(b)
          .find(".over .background")
          .css("margin-left", Math.floor(c[m] / 2));
        $(b)
          .find(".over .background")
          .css("margin-top", d / 2);
      });
      ...
      $(".menus .menu").click(
        Utils.delegate(this, function (b) {
          b = $(b.currentTarget).attr("class").split(" ")[1];
          a.dispatch(this.MENU_CLICKED, { name: b });
        })
      );
    });
  ...
  this.setSelected = function (a, d) {
    ...
    $(d + ".menus .menu .over")
      .stop()
      .fadeTo(200, 0);
    $(d + ".menus .menu .selected")
      .stop()
      .fadeTo(200, 0);
    $(d + ".menus .menu." + a + " .selected")
      .stop()
      .fadeTo(200, 1);
  };
  d();
...
var SlideShow = function (a, b, d) {
  var c = null,
    ...
    h = function (a) {
      ...
      a &&
        (a.dataset
          ? (b = a.dataset.slide_index)
          : (a = a.getAttribute("data-slide_index")) && (b = a));
      return Number(b);
    },
    n = function (a, b) {
      a &&
        (a.dataset
          ? (a.dataset.slide_index = b)
          : a.setAttribute("data-slide_index", b));
    };
  (function () {
...
var Screenshots = function () {
  ...
  $(".screenshots img").each(function (b, d) {
    a.push({ slide: d, indicatorOn: null, indicatorOff: null });
  });
  ...
  b.hide();
  d.hide();
  $(".screenshotsFrame .previous").hover(
    function () {
      b.stop().fadeTo(750, 1);
    },
    function () {
...
var RoboHand = function () {
  var a = $(".page3 .roboHand"),
    ...
    k = function (a) {
      b.stop().animate({ rotate: "5deg" }, 150, "linear", function () {
        b.stop().animate({ rotate: "0deg" }, 150, a);
      });
      d.stop().animate({ rotate: "-5deg" }, 150, "linear", function () {
        d.stop().animate({ rotate: "0deg" }, 150, a);
      });
    },
    l = function () {
      c.css("display", "block");
    ...
    f = function () {
      ...
      for (f = 0; f < b + 1; f++) {
        var k = a[(d + f) % a.length],
          l = 1;
        f === b && (l = 0);
        $(k).animate({ top: "+=" + e[d], opacity: l }, 1200);
      }
  ...
  (function () {
    for (var b = (c = 0), m = 0; m < a.length; m++) {
      var k = a[m],
        ...
        s = 0;
      $(n).css("marginTop") &&
        (q = Number($(n).css("marginTop").replace(/px$/, "")));
      $(n).css("marginBottom") &&
        (s = Number($(n).css("marginBottom").replace(/px$/, "")));
      l[h] = p + q + s;
...
var DragAndDrop = {
  ...
  init: function () {
    window.onmousemove = Utils.delegate(this, function (a) {
      if (null !== this.activeElement) {
        ...
        if (null !== this.lastX) {
          var d = b - this.lastX,
            c = window
              .getComputedStyle(this.activeElement)
              .left.replace(/px/, ""),
            c = parseInt("" !== c ? c : "0");
        ...
        if (null !== this.lastY) {
          var d = a - this.lastY,
            ...
            e = parseInt("" !== e ? e : "0");
          this.activeElement.style[c ? "bottom" : "top"] =
            e + (c ? -1 : 1) * d + "px";
        }
        this.lastX = b;
        this.lastY = a;
    ...
    window.addEventListener(
      "mouseup",
      Utils.delegate(this, function (a) {
      ...
      Utils.delegate(this, function (a) {
        ...
        if (48 <= a.keyCode && 57 >= a.keyCode)
          null !== this.activeElement &&
            document
              .getElementById("layer" + (a.keyCode - 48))
              .getElementsByClassName("page1")[0]
              .appendChild(this.activeElement);
    ...
    $(".cloud").each(
      Utils.delegate(this, function (a, b) {
        this.add(b);
      })
    );
  },
  ...
  var m = function () {
    ...
    k = function () {
      0.02 < f
        ? ((f -= 0.02),
          (e += 0.05),
          (a.style[Modernizr.prefixed("transform")] =
            "rotate(" + f * Math.sin(e) + "deg)"))
        : ((e = f = 0), null !== g && (clearInterval(g), (g = null)));
    };
};
...
var Dev = (function () {
  this.checkAndInit = function () {
    -1 !== window.location.href.indexOf("#dev") &&
      ($(".togglePage2Layer3").click(function (a, b) {
        "1000" === $("#page2_layer3").css("z-index")
          ? $("#page2_layer3").css("z-index", "")
          : $("#page2_layer3").css("z-index", "1000");
      }),
...
var Robo = function () {
  var a = $(".page1 .armLeft"),
    b = $(".page1 .armRight"),
    d = function () {
      a.stop().animate({ rotate: "10deg" }, 7500, function () {
        a.stop().animate({ rotate: "-3deg" }, 7500);
      });
    },
    c = function () {
      b.stop().animate({ rotate: "-7deg" }, 1e4, function () {
        b.stop().animate({ rotate: "0deg" }, 1e4);
      });
    };
  (function () {
    d();
    ...
    b = function () {
      a.animate(
        { marginTop: "-=12px" },
        {
          ...
          queue: !1,
          complete: function () {
            a.animate({ marginTop: "+=12px" }, { duration: 1250, queue: !1 });
          },
        }
      );
    },
    d = function () {
      a.animate(
        { rotate: "2deg" },
        {
          ...
          queue: !1,
          complete: function () {
            a.animate({ rotate: "-2deg" }, { duration: 2250, queue: !1 });
          },
        }
      );
    };
...
var ScrollIndicator = function (a) {
  ...
  var k = Utils.delegate(this, function () {
      b.dispatch(this.POSITION_CHANGED, { position: f });
    }),
    l = function () {
      0 > f ? (f = 0) : 1 < f && (f = 1);
...
var Main = function () {
  var a = null,
    ...
    h = function () {
      w();
      e
        ? ($("html").addClass("no-parallaxe"),
          $(".page1").attr("id", "home"),
          $(".page2").attr("id", "apps"),
          $(".page3").attr("id", "about"),
          $(".page4").attr("id", "contact"))
        : $("html").addClass("parallaxe");
      if (!1 == e) {
        var a = $(".page0 img");
        g = a.length;
        a.each(function (a, b) {
    ...
    r = function () {
      ...
      !1 === e &&
        ...
        (new Robo(), new Baloons(), new RoboHand());
      ...
      b.addEventListener("show", function (a) {
        a.containerElement
          .find(".image .over")
          .stop()
          .animate({ rotate: "-90deg", opacity: 1 }, a.duration);
        a.containerElement
          .find(".image .out")
          .stop()
          .animate({ rotate: "-90deg" }, a.duration);
      });
      b.addEventListener("hide", function (a) {
        a.containerElement
          .find(".image .over")
          .stop()
          .animate({ rotate: "0deg", opacity: 0 }, a.duration);
        a.containerElement
          .find(".image .out")
          .stop()
          .animate({ rotate: "0deg" }, a.duration);
      });
      Dev.checkAndInit();
      !1 === e &&
        ((b = a.getLocation()),
        0 === window.pageYOffset &&
          (b
            ? ((b = d.getGroupScrollPosition(b)), $(document).scrollTop(b))
            : $(document).scrollTop(d.getGroupScrollPosition("home"))));
      t();
    },
    w = function () {
      var a = null;
    ...
    u = function () {
      ...
      !1 === e &&
        (c.addEventListener(ParallaxerEvent.AFTER_LOOP_STOP, function () {
          $(".page0").remove();
        }),
        d.start(),
