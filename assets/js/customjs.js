...
function init() {
  new SmoothScroll(document, 15, 30);
}
...
window.addEventListener("scroll", function () {
  ...
  background3Page4.style.transform = "translateY(" + value * -0.03 + "px)";
